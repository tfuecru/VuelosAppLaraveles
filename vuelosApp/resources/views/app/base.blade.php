...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">FlightApp</a>
    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
            ...
            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
              ...
              <ul class="nav flex-column mb-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ url('flight') }}">
                    <svg class="bi">
                      <use xlink:href="#fligth" />
                    </svg>
                    Flight
                  </a>
                </li>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <!--content-->
          <h2>@yield('title', 'Flight Index Public')</h2>
          @yield('content')
